                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            parsed_value = value
                    # Handle 'NA' response: no facts after filter
                    if isinstance(parsed_value, str) and parsed_value.strip().upper() == "NA":
                        return []
                    # Handle malformed fact_after_filter: non-dict or missing 'fact' key
                    if not isinstance(parsed_value, dict) or 'fact' not in parsed_value:
                        print(f"Warning: malformed fact_after_filter, returning empty list. Value:\n{value}")
                        return []
