...
def main():
    parser = argparse.ArgumentParser(description="HippoRAG retrieval and QA with Gemini 2.0")
    parser.add_argument('--dataset', type=str, default='musique', help='Dataset name')
    parser.add_argument('--llm_base_url', type=str, default='https://generativelanguage.googleapis.com/v1beta/openai/', help='Gemini API base URL')
    parser.add_argument('--llm_name', type=str, default='gemini-2.5-flash', help='LLM name')
    ...
    # Create two separate save directories:
    # 1. Reusable directory for embeddings and OpenIE (dataset_univ)
    # 2. Method/LLM-specific directory for LLM caches
